...
<html lang="en">
	<head>
		...
		<script src="./Script/js/async.js" type="text/javascript"></script>
		<script src="./Script/js/database.js" type="text/javascript"></script>
	...
	<body>
		<div id="wrapper">
			...
			<nav>
				<p>
					<a href="./index_jquery.php">jQuery Version</a>
				</p>
			</nav>
